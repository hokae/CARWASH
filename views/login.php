                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form action="../page/authentication.php?function=login&&sub_page=login" method="$_POST" class="user">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="../page/authentication.php?sub_page=register">Create an Account!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
